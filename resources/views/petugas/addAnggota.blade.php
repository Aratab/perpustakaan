...
@section('content')
<script>document.title = "Tambah Anggota - Perpustakaan"</script>
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h1 class="h2">Tambah Anggota</h1>
    </div>
          <div class="card">
            <div class="card-header"><h4 class="card-title">Masukkan Data Anggota</h4></div>
            <div class="card-body">
              <div class="col-lg-12">
                <form method="POST" action="addAnggota/sukses">
                  @csrf
                  <div class="row">
                    <div class="col">
