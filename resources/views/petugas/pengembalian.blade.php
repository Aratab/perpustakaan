...
@section('content')
<script>document.title = "Pemgembalian - Perpustakaan"</script>
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
  ...
  <div class="table-responsive">
    ...
    <button type="button" class="btn btn-primary" onclick="location.href='/petugas/kirimdenda/{{ $peminjaman->idtransaksi }}/{{ $idbuku }}'">Kirim</button>
    <button type="button" class="btn btn-secondary" onclick="location.href='{{ route('petugas.peminjaman')}}'">Cancel</button>
  </div>
</main>
@endsection
